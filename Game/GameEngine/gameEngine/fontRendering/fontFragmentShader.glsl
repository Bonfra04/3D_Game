...
const float borderWidth = 0.0; // aumenta per un bordo
const vec3 outlineColour = vec3(0.0, 0.0, 0.0); // colore del bordo
...
void main(void) {
	...
	float outlineAlpha = 1.0
			- smoothstep(borderWidth, borderWidth + borderEdge, distance2);
